...
package com.mycompany.javagpaassignment;

/**
 *
 * @author IDOWU
 */
//public class JavaGpaAssignment {
//
...
public class JavaGpaAssignment {
   ...
   public int getPoint(String grade){
    ...
    public static void main(String[] args) {
        ...
        //score
        JavaGpaAssignment student = new JavaGpaAssignment(); 
        
        String grade1 = student.getGrade(score1);
        String grade2 = student.getGrade(score2);
        String grade3 = student.getGrade(score3);
        String grade4 = student.getGrade(score4);
        String grade5 = student.getGrade(score5);
        
        int point1 = student.getPoint(grade1); 
        int point2 = student.getPoint(grade2); 
        int point3 = student.getPoint(grade3); 
        int point4 = student.getPoint(grade4); 
        int point5 = student.getPoint(grade5); 
